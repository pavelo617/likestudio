                            ...
                            d.hide(), d.on("click", function() {
                                ...
                                try {
                                    ...
                                    i.append(a), i.append(s), i.appendTo("body").hide(), i.ajaxSubmit({
                                        ...
                                        error: function(e) {
                                            try {
                                                plp.msg_error(plp.l10n("РћС€РёР±РєР° Р·Р°РіСЂСѓР·РєРё!"), 400 === e.status ? e.responseText : null), c.html(c.data("original-html")), t.data("result", null), r.trigger("change"), i.remove()
                                            } catch (n) {
